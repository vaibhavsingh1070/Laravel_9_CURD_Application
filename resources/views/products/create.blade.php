            ...
            <div class="card borde-0 shadaow-lg my-4">
                ...
                <!-- value="{{old('sku')}}" this prevents input from being cleared after incorrect data submission-->
                    ...
                    <div class="mb-3">
                        ...
                        <input type="number" value="{{old('price')}}" class="form-control form-control-lg" placeholder="Price" name="price">
                        @error('price')
                            <p class="invalid-feedback">{{ $message }}</p>
                        @enderror
                    </div>
                    <div class="mb-3">
                        ...
                        <textarea class="form-control" name="description"  cols="30" rows="5" placeholder="Product Description"></textarea>
                    </div>
                    <div class="mb-3">
